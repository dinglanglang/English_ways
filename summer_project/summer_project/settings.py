...
SECRET_KEY = 'va-7*&wwxw_y@%(n$#lb^4etn1jv^a_jid=*1vg4ihn=5$@4%e'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://192.168.0.112:6379',
        "OPTIONS": {
...
# 发件人的邮箱
EMAIL_HOST_USER = '1303342763@qq.com'
# 发件人邮箱密码
EMAIL_HOST_PASSWORD = 'oohglxnrcusxffbb'
# tls协议，有True和False两种情况
EMAIL_USE_TLS = True
# 发件人的邮箱
EMAIL_FROM = '1303342763@qq.com'
